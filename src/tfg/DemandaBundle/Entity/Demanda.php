...
namespace tfg\DemandaBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="tfg\DemandaBundle\Repository\DemandaRepository")
 */
class Demanda
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="tfg\OfertaBundle\Entity\Oferta")
     */
    private $oferta;


    /**
    * @ORM\ManyToOne(targetEntity="tfg\VisitasDemandaBundle\Entity\VisitasDemanda")
    */
    private $visitasDemanda;
